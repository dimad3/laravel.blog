            ...
            <div class="container">
                                    ...
                                    <a href="marketing-single.html"
                                        ...
                                        <div class="w-100 justify-content-between">
                                            <img src="assets/front/upload/small_01.jpg" alt=""
                                                class="img-fluid float-left">
                                            <h5 class="mb-1">Banana-chip chocolate cake recipe with customs
                                            </h5>
                                            <span class="rating">
                                    ...
                                    <a href="marketing-single.html"
                                        ...
                                        <div class="w-100 justify-content-between">
                                            <img src="assets/front/upload/small_02.jpg" alt=""
                                                class="img-fluid float-left">
                                            <h5 class="mb-1">10 practical ways to choose organic vegetables
                                            </h5>
                                            <span class="rating">
                                                <i class="fa fa-star"></i>
                                                <i class="fa fa-star"></i>
                                    ...
                                    <a href="marketing-single.html"
                                        ...
                                        <div class="w-100 last-item justify-content-between">
                                            <img src="assets/front/upload/small_03.jpg" alt=""
                                                class="img-fluid float-left">
                                            <h5 class="mb-1">We are making homemade ravioli, nice and good
                                            </h5>
                                            <span class="rating">
                                                <i class="fa fa-star"></i>
                                                <i class="fa fa-star"></i>
                ...
                <div class="row">
                    <div class="col-md-12 text-center">
                        <br>
                        <br>
                        <div class="copyright">&copy; Markedia. Design: <a href="http://html.design">HTML
                                Design</a>.</div>
                    </div>
                </div>
            </div><!-- end container -->
